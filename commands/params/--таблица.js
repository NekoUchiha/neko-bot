...
setTimeout(function() {
    if(statick == "1"){
    message.guild.channels.find("name", "annonsi").send( `@everyone ${statick} статик, Таблица времени рейда ${reidname} сброшена, просьба заполнить данные на эту неделю до среды!!!!
